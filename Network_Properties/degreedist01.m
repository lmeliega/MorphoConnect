function [x, y, cy, Network_Params] = degreedist01(Mat, Mat_rand)
...
% This function was modified by Lester Melie Garcia
...
try
    ...
    if I==1
        ...
        Network_Params.NetworkType = 'Broad-Scale behaviour: a*x^(-b)*exp(-x/c)';
        Network_Params.a = a_BS;
        Network_Params.b = b_BS;
        Network_Params.c = c_BS;
        %     figure
        %     plot(x,y)
        %     hold on
        %     plot(fresult_BS)
    elseif I==2
        ...
        Network_Params.NetworkType = 'Scale-Free behaviour: a*x^(-b)';
        Network_Params.a = a_SF;
        Network_Params.b = b_SF;
        Network_Params.c = 0;
        %     figure
        %     plot(x,y)
        %     hold on
    ...
    elseif I==3
        ...
        Network_Params.NetworkType = 'Single-Scale behaviour: a*exp(-x/c)';
        Network_Params.a = a_SS;
        Network_Params.b = 0;
        Network_Params.c = c_SS;        
        %     figure
        %     plot(x,y)
        %     hold on
        %     plot(fresult_SS)
