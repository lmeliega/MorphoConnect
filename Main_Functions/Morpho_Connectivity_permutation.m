...
% Last Modified by GUIDE v2.5 13-Nov-2012 14:47:12
...
if IsMakeBoostraping
    ...
    if Nm==2
        ...
        if LoadBootstrapSamples
            ...
            [ConnectMatrix1,XX,ind,ConMat1p]= Morpho_bootstrap01(Y1,'',0,0,ind,Connectivity_Method); %#ok % Case of one dataset.
        else
            [ConnectMatrix1,XX,indbootstrap,ConMat1p] = Morpho_bootstrap01(Y1,'',Nboot,Nsubj,'',Connectivity_Method,isReplacement); %#ok % Case of one dataset.
        end;
    end;
else
    [ConnectMatrix1,ConMat1p] = ConnectMatrixCalc(Y1, Connectivity_Method);
