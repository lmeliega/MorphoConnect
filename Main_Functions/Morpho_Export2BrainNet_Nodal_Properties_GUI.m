function varargout = Morpho_Export2BrainNet_Nodal_Properties_GUI(varargin)
% MORPHO_EXPORT2BRAINNET_NODAL_PROPERTIES_GUI M-file for Morpho_Export2BrainNet_Nodal_Properties_GUI.fig
%      MORPHO_EXPORT2BRAINNET_NODAL_PROPERTIES_GUI, by itself, creates a new MORPHO_EXPORT2BRAINNET_NODAL_PROPERTIES_GUI or raises the existing
%      singleton*.
%
%      H = MORPHO_EXPORT2BRAINNET_NODAL_PROPERTIES_GUI returns the handle to a new MORPHO_EXPORT2BRAINNET_NODAL_PROPERTIES_GUI or the handle to
%      the existing singleton*.
%
%      MORPHO_EXPORT2BRAINNET_NODAL_PROPERTIES_GUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in MORPHO_EXPORT2BRAINNET_NODAL_PROPERTIES_GUI.M with the given input arguments.
%
%      MORPHO_EXPORT2BRAINNET_NODAL_PROPERTIES_GUI('Property','Value',...) creates a new MORPHO_EXPORT2BRAINNET_NODAL_PROPERTIES_GUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Morpho_Export2BrainNet_Nodal_Properties_GUI_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Morpho_Export2BrainNet_Nodal_Properties_GUI_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Morpho_Export2BrainNet_Nodal_Properties_GUI

% Last Modified by GUIDE v2.5 19-Feb-2014 23:45:13

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Morpho_Export2BrainNet_Nodal_Properties_GUI_OpeningFcn, ...
                   'gui_OutputFcn',  @Morpho_Export2BrainNet_Nodal_Properties_GUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Morpho_Export2BrainNet_Nodal_Properties_GUI is made visible.
function Morpho_Export2BrainNet_Nodal_Properties_GUI_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Morpho_Export2BrainNet_Nodal_Properties_GUI (see VARARGIN)

% Choose default command line output for Morpho_Export2BrainNet_Nodal_Properties_GUI
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes Morpho_Export2BrainNet_Nodal_Properties_GUI wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = Morpho_Export2BrainNet_Nodal_Properties_GUI_OutputFcn(hObject, eventdata, handles) 
...
Export2_BrainNet_Nodal_Props(NetworkPropertiesFiles,StructuresCodeFile,CentroidsFile,OutputFolder);
