function varargout = Morpho_NetProps_Stats_plus_Area_Permutations(varargin)
%MORPHO_NETPROPS_STATS_PLUS_AREA_PERMUTATIONS M-file for Morpho_NetProps_Stats_plus_Area_Permutations.fig
%      MORPHO_NETPROPS_STATS_PLUS_AREA_PERMUTATIONS, by itself, creates a new MORPHO_NETPROPS_STATS_PLUS_AREA_PERMUTATIONS or raises the existing
%      singleton*.
%
%      H = MORPHO_NETPROPS_STATS_PLUS_AREA_PERMUTATIONS returns the handle to a new MORPHO_NETPROPS_STATS_PLUS_AREA_PERMUTATIONS or the handle to
%      the existing singleton*.
%
%      MORPHO_NETPROPS_STATS_PLUS_AREA_PERMUTATIONS('Property','Value',...) creates a new MORPHO_NETPROPS_STATS_PLUS_AREA_PERMUTATIONS using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to Morpho_NetProps_Stats_plus_Area_Permutations_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      MORPHO_NETPROPS_STATS_PLUS_AREA_PERMUTATIONS('CALLBACK') and MORPHO_NETPROPS_STATS_PLUS_AREA_PERMUTATIONS('CALLBACK',hObject,...) call the
%      local function named CALLBACK in MORPHO_NETPROPS_STATS_PLUS_AREA_PERMUTATIONS.M with the given input
%      arguments.
%
...
% Edit the above text to modify the response to help Morpho_NetProps_Stats_plus_Area_Permutations
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @Morpho_NetProps_Stats_plus_Area_Permutations_OpeningFcn, ...
                   'gui_OutputFcn',  @Morpho_NetProps_Stats_plus_Area_Permutations_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
% --- Executes just before Morpho_NetProps_Stats_plus_Area_Permutations is made visible.
function Morpho_NetProps_Stats_plus_Area_Permutations_OpeningFcn(hObject, eventdata, handles, varargin)
...
% Choose default command line output for Morpho_NetProps_Stats_plus_Area_Permutations
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes Morpho_NetProps_Stats_plus_Area_Permutations wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = Morpho_NetProps_Stats_plus_Area_Permutations_OutputFcn(hObject, eventdata, handles)
...
Net_Stats = NetProps_Area_Statistic(NetProps1,NetProps2,Npermut,Stat);
