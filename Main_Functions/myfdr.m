function [n_signif,index_signif] = myfdr(pvals,qlevel,method,adjustment_method,adjustment_args)
%
% Attribution:
%
...
% Description:
%
%    This is the main function designed for general usage for
%    determining significance based on the FDR approach.
%
% Arguments:
%
