function [Net_Stats,ResultsTable] = NetProps_compare_groups_Stat_bootstrap01(NetProps1,NetProps2,NetProps1_boot,NetProps2_boot,pvalue)
...
if (isfield(NetProps1,'kmean'))&&(isfield(NetProps2,'kmean'))&&(isfield(NetProps1_boot,'kmean'))&&(isfield(NetProps2_boot,'kmean'))
...
if (ind2trunc1==1)&&(ind2trunc2==1)
    ...
    ind2trunc = min(ind2trunc1,ind2trunc2)-6;
end;
Structures=NetProps1.Structures;
...
if isfield(NetProps1,'Name')
    Net_Stats.G1=NetProps1.Name;
end;
if isfield(NetProps1_boot,'Name')
    Net_Stats.G1Boot=NetProps1_boot.Name;
end;
if isfield(NetProps2,'Name')
    Net_Stats.G2=NetProps2.Name;
end;
if isfield(NetProps2_boot,'Name')
    Net_Stats.G2Boot=NetProps2_boot.Name;
end;
...
if (isfield(NetProps1,'Clux'))&&(isfield(NetProps2,'Clux'))&&(isfield(NetProps1_boot,'Clux'))&&(isfield(NetProps2_boot,'Clux'))
    ...
    [pT,ppT,pT_corrected,ppT_corrected,pA,ppA,pA_corrected,ppA_corrected,ci,ciA,dm,dbmean] = Bootstrap_Test_compare_groups01(Clux1,Clux2,Clux1b,Clux2b,pvalue,false);
    Net_Stats.Clux.p = pT;
    Net_Stats.Clux.psignif = ppT;
    Net_Stats.Clux.p_corrected = pT_corrected;
    Net_Stats.Clux.p_corrected_signif = ppT_corrected;
    Net_Stats.Clux.pArea = pA;
    Net_Stats.Clux.pAreasignif = ppA;
    Net_Stats.Clux.pArea_corrected = pA_corrected;
    Net_Stats.Clux.pArea_corrected_signif = ppA_corrected;
...
if isfield(NetProps1,'CharPathL')&&(isfield(NetProps2,'CharPathL'))&&(isfield(NetProps1_boot,'CharPathL'))&&(isfield(NetProps2_boot,'CharPathL'))
    ...
    [pT,ppT,pT_corrected,ppT_corrected,pA,ppA,pA_corrected,ppA_corrected,ci,ciA,dm,dbmean] = Bootstrap_Test_compare_groups01(CharPathL1,CharPathL2,CharPathL1b,CharPathL2b,pvalue,false);
    Net_Stats.CharPathL.p = pT;
    Net_Stats.CharPathL.psignif = ppT;
    Net_Stats.CharPathL.p_corrected = pT_corrected;
    Net_Stats.CharPathL.p_corrected_signif = ppT_corrected;
    Net_Stats.CharPathL.pArea = pA;
    Net_Stats.CharPathL.pAreasignif = ppA;
    Net_Stats.CharPathL.pArea_corrected = pA_corrected;
    Net_Stats.CharPathL.pArea_corrected_signif = ppA_corrected;
...
if isfield(NetProps1,'TargetAttack')&&(isfield(NetProps2,'TargetAttack'))&&(isfield(NetProps1_boot,'TargetAttack'))&&(isfield(NetProps2_boot,'TargetAttack'))
    ...
    [pT,ppT,pT_corrected,ppT_corrected,pA,ppA,pA_corrected,ppA_corrected,ci,ciA,dm,dbmean] = Bootstrap_Test_compare_groups01(TAttack1,TAttack2,TAttack1b,TAttack2b,pvalue,false);
    Net_Stats.TargetAttack.p = pT;
    Net_Stats.TargetAttack.psignif = ppT;
    Net_Stats.TargetAttack.p_corrected = pT_corrected;
    Net_Stats.TargetAttack.p_corrected_signif = ppT_corrected;
    Net_Stats.TargetAttack.pArea = pA;
    Net_Stats.TargetAttack.pAreasignif = ppA;
    Net_Stats.TargetAttack.pArea_corrected = pA_corrected;
    Net_Stats.TargetAttack.pArea_corrected_signif = ppA_corrected;
...
if isfield(NetProps1,'Efficiency')&&(isfield(NetProps2,'Efficiency'))&&(isfield(NetProps1_boot,'Efficiency'))&&(isfield(NetProps2_boot,'Efficiency'))
    ...
    [pT,ppT,pT_corrected,ppT_corrected,pA,ppA,pA_corrected,ppA_corrected,ci,ciA,dm,dbmean] = Bootstrap_Test_compare_groups01(Eloc1,Eloc2,Eloc1b,Eloc2b,pvalue,false);
    Net_Stats.Elocal.p = pT;
    Net_Stats.Elocal.psignif = ppT;
    Net_Stats.Elocal.p_corrected = pT_corrected;
    Net_Stats.Elocal.p_corrected_signif = ppT_corrected;
    Net_Stats.Elocal.pArea = pA;
    Net_Stats.Elocal.pAreasignif = ppA;
    Net_Stats.Elocal.pArea_corrected = pA_corrected;
    Net_Stats.Elocal.pArea_corrected_signif = ppA_corrected;
    ...
    [pT,ppT,pT_corrected,ppT_corrected,pA,ppA,pA_corrected,ppA_corrected,ci,ciA,dm,dbmean] = Bootstrap_Test_compare_groups01(Eglob1,Eglob2,Eglob1b,Eglob2b,pvalue,false);
    Net_Stats.Eglobal.p = pT;
    Net_Stats.Eglobal.psignif = ppT;
    Net_Stats.Eglobal.p_corrected = pT_corrected;
    Net_Stats.Eglobal.p_corrected_signif = ppT_corrected;
    Net_Stats.Eglobal.pArea = pA;
    Net_Stats.Eglobal.pAreasignif = ppA;
    Net_Stats.Eglobal.pArea_corrected = pA_corrected;
    Net_Stats.Eglobal.pArea_corrected_signif = ppA_corrected;    
...
if isfield(NetProps1,'NodalEfficiency')&&(isfield(NetProps2,'NodalEfficiency'))&&(isfield(NetProps1_boot,'NodalEfficiency'))&&(isfield(NetProps2_boot,'NodalEfficiency'))
    ...
    if ndims(NodalP1b)==3
        [pT,ppT,pT_corrected,ppT_corrected,pA,ppA,pA_corrected,ppA_corrected,ci,ciA,dm,dbmean] = Bootstrap_Test_compare_groups01(NodalP1,NodalP2,NodalP1b,NodalP2b,pvalue,false);
    else
        [pT,ppT,pT_corrected,ppT_corrected,pA,ppA,pA_corrected,ppA_corrected,ci,ciA,dm,dbmean] = Bootstrap_Test_compare_groups01(NodalP1,NodalP2,NodalP1b,NodalP2b,pvalue,true);
    end;
    ind_signif = sum(ppT_corrected,2)>0; 
    Net_Stats.NodalEfficiency.p = pT;
    Net_Stats.NodalEfficiency.psignif = ppT;
    Net_Stats.NodalEfficiency.p_corrected = pT_corrected;
    Net_Stats.NodalEfficiency.p_corrected_signif = ppT_corrected;
    Net_Stats.NodalEfficiency.pArea = pA;
    Net_Stats.NodalEfficiency.pAreasignif = ppA;
    Net_Stats.NodalEfficiency.pArea_corrected = pA_corrected;
    Net_Stats.NodalEfficiency.pArea_corrected_signif = ppA_corrected;
    Net_Stats.NodalEfficiency.p_corrected_Structures = Structures(ind_signif);
    Net_Stats.NodalEfficiency.pAreaStructures=Structures(logical(ppA));
    Net_Stats.NodalEfficiency.pArea_corrected_Structures=Structures(logical(ppA_corrected));
...
if isfield(NetProps1,'VulnerabilityMat')&&(isfield(NetProps2,'VulnerabilityMat'))&&(isfield(NetProps1_boot,'VulnerabilityMat'))&&(isfield(NetProps2_boot,'VulnerabilityMat'))
    ...
    Net_Stats.VulnerabilityMat.psignif = ppT;
    Net_Stats.VulnerabilityMat.p_corrected = pT_corrected;
    Net_Stats.VulnerabilityMat.p_corrected_signif = ppT_corrected;
    Net_Stats.VulnerabilityMat.pArea = pA;
    Net_Stats.VulnerabilityMat.pAreasignif = ppA;
    Net_Stats.VulnerabilityMat.pArea_corrected = pA_corrected;
    Net_Stats.VulnerabilityMat.pArea_corrected_signif = ppA_corrected;
    Net_Stats.VulnerabilityMat.p_corrected_Structures = Structures(ind_signif);
    Net_Stats.VulnerabilityMat.pAreaStructures=Structures(logical(ppA));
    Net_Stats.VulnerabilityMat.pArea_corrected_Structures=Structures(logical(ppA_corrected));
...
if isfield(NetProps1,'CentrBet')&&(isfield(NetProps2,'CentrBet'))&&(isfield(NetProps1_boot,'CentrBet'))&&(isfield(NetProps2_boot,'CentrBet'))
    ...
    Net_Stats.CentrBet.psignif = ppT;
    Net_Stats.CentrBet.p_corrected = pT_corrected;
    Net_Stats.CentrBet.p_corrected_signif = ppT_corrected;
    Net_Stats.CentrBet.pArea = pA;
    Net_Stats.CentrBet.pAreasignif = ppA;
    Net_Stats.CentrBet.pArea_corrected = pA_corrected;
    Net_Stats.CentrBet.pArea_corrected_signif = ppA_corrected;
    Net_Stats.CentrBet.p_corrected_Structures = Structures(ind_signif);
    Net_Stats.CentrBet.pAreaStructures=Structures(logical(ppA));
    Net_Stats.CentrBet.pArea_corrected_Structures=Structures(logical(ppA_corrected));
...
if isfield(NetProps1,'CentrBetNorm')&&(isfield(NetProps2,'CentrBetNorm'))&&(isfield(NetProps1_boot,'CentrBetNorm'))&&(isfield(NetProps2_boot,'CentrBetNorm'))
    ...
    Net_Stats.CentrBetNorm.psignif = ppT;
    Net_Stats.CentrBetNorm.p_corrected = pT_corrected;
    Net_Stats.CentrBetNorm.p_corrected_signif = ppT_corrected;
    Net_Stats.CentrBetNorm.pArea = pA;
    Net_Stats.CentrBetNorm.pAreasignif = ppA;
    Net_Stats.CentrBetNorm.pArea_corrected = pA_corrected;
    Net_Stats.CentrBetNorm.pArea_corrected_signif = ppA_corrected;
    Net_Stats.CentrBetNorm.p_corrected_Structures = Structures(ind_signif);
    Net_Stats.CentrBetNorm.pAreaStructures=Structures(logical(ppA));
    Net_Stats.CentrBetNorm.pArea_corrected_Structures=Structures(logical(ppA_corrected));
...
if isfield(NetProps1,'NodalClux')&&(isfield(NetProps2,'NodalClux'))&&(isfield(NetProps1_boot,'NodalClux'))&&(isfield(NetProps2_boot,'NodalClux'))
    ...
    Net_Stats.NodalClux.psignif = ppT;
    Net_Stats.NodalClux.p_corrected = pT_corrected;
    Net_Stats.NodalClux.p_corrected_signif = ppT_corrected;
    Net_Stats.NodalClux.pArea = pA;
    Net_Stats.NodalClux.pAreasignif = ppA;
    Net_Stats.NodalClux.pArea_corrected = pA_corrected;
    Net_Stats.NodalClux.pArea_corrected_signif = ppA_corrected;
    Net_Stats.NodalClux.p_corrected_Structures = Structures(ind_signif);
    Net_Stats.NodalClux.pAreaStructures=Structures(logical(ppA));
    Net_Stats.NodalClux.pArea_corrected_Structures=Structures(logical(ppA_corrected));
...
if isfield(NetProps1,'NodeConnection')&&(isfield(NetProps2,'NodeConnection'))&&(isfield(NetProps1_boot,'NodeConnection'))&&(isfield(NetProps2_boot,'NodeConnection'))
    ...
    Net_Stats.NodeConnection.psignif = ppT;
    Net_Stats.NodeConnection.p_corrected = pT_corrected;
    Net_Stats.NodeConnection.p_corrected_signif = ppT_corrected;
    Net_Stats.NodeConnection.pArea = pA;
    Net_Stats.NodeConnection.pAreasignif = ppA;
    Net_Stats.NodeConnection.pArea_corrected = pA_corrected;
    Net_Stats.NodeConnection.pArea_corrected_signif = ppA_corrected;
    Net_Stats.NodeConnection.p_corrected_Structures = Structures(ind_signif);
    Net_Stats.NodeConnection.pAreaStructures=Structures(logical(ppA));
    Net_Stats.NodeConnection.pArea_corrected_Structures=Structures(logical(ppA_corrected));
...
if isfield(NetProps1,'GlobalConnectivity')&&(isfield(NetProps2,'GlobalConnectivity'))&&(isfield(NetProps1_boot,'GlobalConnectivity'))&&(isfield(NetProps2_boot,'GlobalConnectivity'))
    ...
    [pT,ppT,pT_corrected,ppT_corrected,pA,ppA,pA_corrected,ppA_corrected,ci,ciA,dm,dbmean] = Bootstrap_Test_compare_groups01(GlobalC1,GlobalC2,GlobalC1b,GlobalC2b,pvalue,true);
    Net_Stats.GlobalConnectivity.p = pT;
    Net_Stats.GlobalConnectivity.psignif = ppT;
    Net_Stats.GlobalConnectivity.p_corrected = pT_corrected;
    Net_Stats.GlobalConnectivity.p_corrected_signif = ppT_corrected;
    Net_Stats.GlobalConnectivity.pArea = pA;
    Net_Stats.GlobalConnectivity.pAreasignif = ppA;
    Net_Stats.GlobalConnectivity.pArea_corrected = pA_corrected;
    Net_Stats.GlobalConnectivity.pArea_corrected_signif = ppA_corrected;
...
if isfield(NetProps1,'HomologousStructConnection')&&(isfield(NetProps2,'HomologousStructConnection'))&&(isfield(NetProps1_boot,'HomologousStructConnection'))&&(isfield(NetProps2_boot,'HomologousStructConnection'))
    ...
    Net_Stats.HomologousStructConnection.psignif = ppT;
    Net_Stats.HomologousStructConnection.p_corrected = pT_corrected;
    Net_Stats.HomologousStructConnection.p_corrected_signif = ppT_corrected;
    Net_Stats.HomologousStructConnection.pArea = pA;
    Net_Stats.HomologousStructConnection.pAreasignif = ppA;
    Net_Stats.HomologousStructConnection.pArea_corrected = pA_corrected;
    Net_Stats.HomologousStructConnection.pArea_corrected_signif = ppA_corrected;
...
if isfield(NetProps1,'Modularity')&&(isfield(NetProps2,'Modularity'))&&(isfield(NetProps1_boot,'Modularity'))&&(isfield(NetProps2_boot,'Modularity'))
    ...
    [pT,ppT,pT_corrected,ppT_corrected,pA,ppA,pA_corrected,ppA_corrected,ci,ciA,dm,dbmean] = Bootstrap_Test_compare_groups01(Modularity1,Modularity2,Modularity1b,Modularity2b,pvalue,false);
    Net_Stats.Modularity.p = pT;
    Net_Stats.Modularity.psignif = ppT;
    Net_Stats.Modularity.p_corrected = pT_corrected;
    Net_Stats.Modularity.p_corrected_signif = ppT_corrected;
    Net_Stats.Modularity.pArea = pA;
    Net_Stats.Modularity.pAreasignif = ppA;
    Net_Stats.Modularity.pArea_corrected = pA_corrected;
    Net_Stats.Modularity.pArea_corrected_signif = ppA_corrected;
...
if isfield(NetProps1,'GlobalCentrBet')&&(isfield(NetProps2,'GlobalCentrBet'))&&(isfield(NetProps1_boot,'GlobalCentrBet'))&&(isfield(NetProps2_boot,'GlobalCentrBet'))
    ...
    [pT,ppT,pT_corrected,ppT_corrected,pA,ppA,pA_corrected,ppA_corrected,ci,ciA,dm,dbmean] = Bootstrap_Test_compare_groups01(GlobalCentrBet1,GlobalCentrBet2,GlobalCentrBet1b,GlobalCentrBet2b,pvalue,false);
    Net_Stats.GlobalCentrBet.p = pT;
    Net_Stats.GlobalCentrBet.psignif = ppT;
    Net_Stats.GlobalCentrBet.p_corrected = pT_corrected;
    Net_Stats.GlobalCentrBet.p_corrected_signif = ppT_corrected;
    Net_Stats.GlobalCentrBet.pArea = pA;
    Net_Stats.GlobalCentrBet.pAreasignif = ppA;
    Net_Stats.GlobalCentrBet.pArea_corrected = pA_corrected;
    Net_Stats.GlobalCentrBet.pArea_corrected_signif = ppA_corrected;
...
Net_Stats.ResamplingMethod = 'Bootstraps';

disp('Bootstrap Test for Network Properties  ...  FINISHED :-)');
