...
% Last Modified by GUIDE v2.5 20-Nov-2010 10:51:43
...
if IsMakeBoostraping
    ...
    if Nm==2
        ConnectMatrix1 = ConnectMatrixCalc(Y1, Connectivity_Method);
        ConnectMatrix2 = ConnectMatrixCalc(Y2, Connectivity_Method);
