function Net_Stats = NetProps_compare_groups_Stat(NetProps1,NetProps2,NetProps1_boot,NetProps2_boot)
...
if isfield(NetProps1,'Clux')&&(isfield(NetProps2,'Clux'))&&(isfield(NetProps1_boot,'Clux'))&&(isfield(NetProps2_boot,'Clux'))
    ...
    if ind2trunc==1
        ...
        [pT,pmax] = Permutation_Test_compare_groups(Clux1,Clux2,Clux1b,Clux2b);
        pA = pT;
    else
        Clux1 = NetProps1.Clux;
        ...
        AClux1b = trapz(Clux1b');
        AClux2b = trapz(Clux2b');
        pA = Permutation_Test_compare_groups(AClux1',AClux2',AClux1b',AClux2b');
        [pT,pmax] = Permutation_Test_compare_groups(Clux1',Clux2',Clux1b,Clux2b);        
    end;
    Net_Stats.Clux.T = pT;
...
if isfield(NetProps1,'CharPathL')&&(isfield(NetProps2,'CharPathL'))&&(isfield(NetProps1_boot,'CharPathL'))&&(isfield(NetProps2_boot,'CharPathL'))
    ...
    if ind2trunc==1
        ...
        [pT,pmax] = Permutation_Test_compare_groups(CharPathL1,CharPathL2,CharPathL1b,CharPathL2b);
        pA = pT;
    else
        CharPathL1 = NetProps1.CharPathL;
        ...
        ACharPathL1b = trapz(CharPathL1b');
        ACharPathL2b = trapz(CharPathL2b');
        pA = Permutation_Test_compare_groups(ACharPathL1',ACharPathL2',ACharPathL1b',ACharPathL2b');
        [pT,pmax] = Permutation_Test_compare_groups(CharPathL1',CharPathL2',CharPathL1b,CharPathL2b);
    end;
...
if isfield(NetProps1,'Efficiency')&&(isfield(NetProps2,'Efficiency'))&&(isfield(NetProps1_boot,'Efficiency'))&&(isfield(NetProps2_boot,'Efficiency'))
    ...
    if ind2trunc==1
        ...
        [pT,pmax] = Permutation_Test_compare_groups(Eloc1,Eloc2,Eloc1b,Eloc2b);
        pA = pT;
    else
        Eloc1 = squeeze(NetProps1.Efficiency(1,:,:))';
        ...
        AEloc1b = trapz(Eloc1b');
        AEloc2b = trapz(Eloc2b');
        pA = Permutation_Test_compare_groups(AEloc1',AEloc2',AEloc1b',AEloc2b');
        [pT,pmax] = Permutation_Test_compare_groups(Eloc1',Eloc2',Eloc1b,Eloc2b);
    end;
    ...
    if ind2trunc==1
        ...
        [pT,pmax] = Permutation_Test_compare_groups(Eglob1,Eglob2,Eglob1b,Eglob2b);
        pA = pT;
    else
        Eglob1 = squeeze(NetProps1.Efficiency(2,:,:))';
        ...
        AEglob1b = trapz(Eglob1b');
        AEglob2b = trapz(Eglob2b');        
        pA = Permutation_Test_compare_groups(AEglob1',AEglob2',AEglob1b',AEglob2b');
        [pT,pmax] = Permutation_Test_compare_groups(Eglob1',Eglob2',Eglob1b,Eglob2b);        
    end;
